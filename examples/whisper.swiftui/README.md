A sample SwiftUI app using [whisper.cpp](https://github.com/xbattlax/whisper.cpp/) to do voice-to-text transcriptions.
See also: [whisper.objc](https://github.com/xbattlax/whisper.cpp/tree/master/examples/whisper.objc).
